...
#Make a popup for generating the short usernames
def open_popup():
   top= Toplevel(window)
...
def massgenerateshort():
    ...
    with open('names.txt', 'w') as file:
        ...
        #N is equal to the value from the slider
        n = Slider.get()
...
label1.grid(row = 9, column = 4, padx= 50, pady= 10)

#Slider for determining how many names you want to generate
Slider = Scale(window, from_=1, to=1000, orient=HORIZONTAL)
Slider.grid(row = 10, column = 4, padx= 50, pady= 10)
