...
#Instead of having to put these big lists of names in every function, I only need to declare them once.
...
#Make a function to clear the input text
def cleartextinput():
   textbox.delete(0, END)

#Make a function to clear the content of the text widget
def click(event):
...
#Setting the title of the window to Name Generator and making the dimensions 750 pixels by 450
...
b1.grid(row = 4, column = 4, padx= 250, pady= 3,)
...
textbox = Entry(window, width = 24)
textbox.insert(INSERT, "Enter the number of names:")
