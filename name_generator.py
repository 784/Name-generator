...
def short():
    ...
    numbers1 = input("Would you like to add numbers to the name? Type 'Y' for yes and 'N' for no: ")
...
def satisfaction1():
    ...
    #If you're satisfied, the loop is completed. The length of your username is also printed
    if satisfied == "Y":
        print("\nYour name is" , len(short.username), "characters! (Including spaces)\n")
        satisfaction = True
