...
mode = input("Do you want to use normal mode or mass generate mode? N for normal, M for mass generate: ")

if mode == "M":

    #Asks if want a long or short name
    userinput = input("\nDo you want short names or long ones? Type short for 'short' ones and 'long' for long ones: ")
